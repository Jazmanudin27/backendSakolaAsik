<div class="container-fluid p-0">
    ...
    <!-- Header -->
    <div class="mb-4">
        <h1 class="h3 mb-1">Data Saya</h1>
        <p class="text-muted">Kelola data profil siswa</p>
    </div>
            ...
            <a href="#" class="text-decoration-none">
                <div class="card border-0 shadow-sm text-center h-100 rounded-4">
                    <div class="card-body py-4">
                        ...
                        <h6 class="mb-0 text-dark">Biodata</h6>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="#" class="text-decoration-none">
                <div class="card border-0 shadow-sm text-center h-100 rounded-4">
                    <div class="card-body py-4">
                        ...
                        <h6 class="mb-0 text-dark">Foto Profil</h6>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="#" class="text-decoration-none">
                <div class="card border-0 shadow-sm text-center h-100 rounded-4">
                    <div class="card-body py-4">
                        ...
                        <h6 class="mb-0 text-dark">Ubah Password</h6>
                    </div>
                </div>
            </a>
        </div>
