<nav id="sidebar" class="sidebar" style="zoom:90%">
    <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="{{ route('siswa.dashboard') }}">
            ...
            <span class="align-middle">{{ Auth::guard('siswa')->user()->nama_siswa ?? 'Siswa' }}</span>
        </a>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link menu-link" data-menu="data-siswa" href="#">
                    <i class="align-middle" data-feather="user"></i>
                    <span class="align-middle">Data Saya</span>
                </a>
            </li>

            <!-- Ujian -->
            <li class="sidebar-item">
                <a class="sidebar-link menu-link" data-menu="ujian" href="#">
                    <i class="align-middle" data-feather="clipboard"></i>
                    <span class="align-middle">Ujian</span>
                </a>
            </li>
