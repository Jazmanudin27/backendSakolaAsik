    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route($userRole . '.siswa.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route($userRole . '.siswa.update', $siswa->kode_siswa) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="kode_sekolah" required>
                                        <option value="">Pilih Sekolah</option>
                                        @if(isset($sekolah))
                                            @foreach($sekolah as $skl)
                                                <option value="{{ $skl->kode_sekolah }}" {{ old('kode_sekolah', $siswa->kode_sekolah) == $skl->kode_sekolah ? 'selected' : '' }}>
                                                    {{ $skl->nama_sekolah }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-select select2" name="kode_kelas" required>
                                        ...
                                        @if(isset($kelas))
                                            @foreach($kelas as $kls)
                                                <option value="{{ $kls->id }}" {{ old('kode_kelas', $siswa->kode_kelas) == $kls->id ? 'selected' : '' }}>
                                                    {{ $kls->nama_kelas }}
                                                </option>
                                            @endforeach
                                        @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="status">
                                        ...
                                        <option value="Keluar/Pindah" {{ old('status', $siswa->status) == 'Keluar/Pindah' ? 'selected' : '' }}>Keluar/Pindah</option>
