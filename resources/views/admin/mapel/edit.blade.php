...
@section('titlepage', 'Form Edit Mata Pelajaran')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1">Edit Data Mata Pelajaran</h1>
                    <p class="text-muted mb-0">Perbarui informasi data mata pelajaran</p>
                </div>
                <div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route($userRole . '.mapel.update', $mapel->id) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="singkatan" class="form-control form-control-sm" placeholder="Contoh: MTK"
                                           value="{{ old('singkatan', $mapel->singkatan) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="kelompok" required>
                                        ...
                                        <option value="Peminatan" {{ old('kelompok', $mapel->kelompok) == 'Peminatan' ? 'selected' : '' }}>Peminatan</option>
                                    </select>
                                    @error('kelompok')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="jenis" required>
                                        ...
                                        <option value="Pilihan" {{ old('jenis', $mapel->jenis) == 'Pilihan' ? 'selected' : '' }}>Pilihan</option>
                                    </select>
                                    @error('jenis')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="jam_per_minggu" class="form-control form-control-sm" placeholder="4"
                                           value="{{ old('jam_per_minggu', $mapel->jam_per_minggu) }}" min="1" max="40" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="deskripsi" class="form-control form-control-sm" rows="4" placeholder="Deskripsi lengkap tentang mata pelajaran">{{ old('deskripsi', $mapel->deskripsi) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="status" required>
                                        ...
                                        <option value="Tidak Aktif" {{ old('status', $mapel->status) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                    </select>
                                    @error('status')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                    ...
                                    <div>
                                        <a href="{{ route($userRole . '.mapel.index') }}" class="btn btn-outline-secondary me-2">
                                            <i class="fas fa-times me-2"></i>Batal
                                        </a>
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-2"></i>Update Data Mata Pelajaran
                                        </button>
                                    </div>
                                </div>
                            </div>
