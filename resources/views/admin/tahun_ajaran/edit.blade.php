...
@section('titlepage', 'Edit Tahun Ajaran')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1">Edit Tahun Ajaran</h1>
                    <p class="text-muted mb-0">Perbarui data tahun ajaran: {{ $tahunAjaran->tahun_ajaran }} {{ $tahunAjaran->semester }}</p>
                </div>
                <div>
                    <a href="{{ route($userRole . '.tahun_ajaran.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route($userRole . '.tahun_ajaran.update', $tahunAjaran->id) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tahun_ajaran" class="form-control form-control-sm" 
                                           placeholder="Contoh: 2024/2025" value="{{ old('tahun_ajaran', $tahunAjaran->tahun_ajaran) }}" required>
                                    @error('tahun_ajaran')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="keterangan" class="form-control form-control-sm" rows="3" 
                                              placeholder="Keterangan tambahan">{{ old('keterangan', $tahunAjaran->keterangan) }}</textarea>
