...
@section('titlepage', 'Form Tambah Admin')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Masukkan data admin baru ke sistem</p>
                </div>
                <div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route($userRole . '.admin.store') }}" method="POST" autocomplete="off">
                        @csrf
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fas fa-save me-2"></i>Simpan Data Admin
                                        </button>
                                    </div>
                                </div>
                            </div>
