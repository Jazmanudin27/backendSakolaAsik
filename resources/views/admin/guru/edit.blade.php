        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Perbarui informasi data guru</p>
                </div>
                <div>
                    <a href="{{ route($userRole . '.guru.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route($userRole . '.guru.update', $guru->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="jk" required>
                                        ...
                                        <option value="Laki-laki" {{ old('jk', $guru->jk) == 'Laki-laki' ? 'selected' : '' }}>
                                            <i class="fas fa-mars me-1"></i>Laki-laki
                                        </option>
                                        <option value="Perempuan" {{ old('jk', $guru->jk) == 'Perempuan' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tgl_lahir" class="form-control form-control-sm"
                                       value="{{ old('tgl_lahir', $guru->tgl_lahir ? $guru->tgl_lahir->format('Y-m-d') : '') }}">
                                    @error('tgl_lahir')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jurusan" class="form-control form-control-sm" placeholder="Contoh: Pendidikan Matematika"
                                       value="{{ old('jurusan', $guru->jurusan) }}" required>
                                    @error('jurusan')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="jabatan" required>
                                        ...
                                        <option value="Wakil Kepala Sekolah" {{ old('jabatan', $guru->jabatan) == 'Wakil Kepala Sekolah' ? 'selected' : '' }}>Wakil Kepala Sekolah</option>
                                    ...
                                    <select class="form-select select2" name="id_sekolah" required>
                                        ...
                                        @if(isset($sekolah))
                                            @foreach($sekolah as $skl)
                                                <option value="{{ $skl->kode_sekolah }}" {{ old('id_sekolah', $guru->id_sekolah) == $skl->kode_sekolah ? 'selected' : '' }}>
                                                    {{ $skl->nama_sekolah }}
                                                </option>
                                            @endforeach
                                        @endif
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-2"></i>Update Data Guru
                                        </button>
                                    </div>
                                </div>
                            </div>
