@extends('layouts.app')
@section('titlepage', 'Edit Ujian')
@section('content')
    @php
        $currentSekolah = $ujian->id_sekolah ?? session('current_sekolah_id');
    @endphp
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 mb-1">Edit Ujian</h1>
                        <p class="text-muted mb-0">Perbarui data ujian</p>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route($userRole . '.ujian.update', $ujian->id) }}" method="POST"
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="kode_ujian" name="kode_ujian"
                                                        value="{{ old('kode_ujian', $ujian->kode_ujian) }}"
                                                    ...
                                                    @if (isset($sekolahs))
                                                        @foreach ($sekolahs as $sekolah)
                                                            <option value="{{ $sekolah->kode_sekolah }}"
                                                                {{ old('id_sekolah', $currentSekolah) == $sekolah->kode_sekolah ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-2">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('tanggal_ujian', \Carbon\Carbon::parse($ujian->tanggal_ujian)->format('Y-m-d')) }}"
                                                    required>
                                                @error('tanggal_ujian')
                                                    <div class="invalid-feedback">
                                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="number"
                                                        ...
                                                        value="{{ old('durasi', $ujian->durasi) }}" min="1"
                                                        max="480" required>
                                                </div>
                                                @error('durasi')
                                                    <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select select2 @error('status') is-invalid @enderror"
                                                    ...
                                                    <option value="Draft"
                                                        {{ old('status', $ujian->status) == 'Draft' ? 'selected' : '' }}>
                                                        Draft</option>
                                                    <option value="Aktif"
                                                        {{ old('status', $ujian->status) == 'Aktif' ? 'selected' : '' }}>
                                                        Aktif</option>
                                                    <option value="Selesai"
                                                        {{ old('status', $ujian->status) == 'Selesai' ? 'selected' : '' }}>
                                                        Selesai</option>
                                                    <option value="Dibatalkan"
                                                        {{ old('status', $ujian->status) == 'Dibatalkan' ? 'selected' : '' }}>
                                                        Dibatalkan</option>
                                                </select>
                                                @error('status')
                                                    <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select select2 @error('tingkat') is-invalid @enderror"
                                                    ...
                                                    <option value="VII"
                                                        {{ old('tingkat', $ujian->tingkat) == 'VII' ? 'selected' : '' }}>
                                                        VII
                                                    </option>
                                                    <option value="VIII"
                                                        {{ old('tingkat', $ujian->tingkat) == 'VIII' ? 'selected' : '' }}>
                                                        VIII
                                                    </option>
                                                    <option value="IX"
                                                        {{ old('tingkat', $ujian->tingkat) == 'IX' ? 'selected' : '' }}>IX
                                                    </option>
                                                    <option value="X"
                                                        {{ old('tingkat', $ujian->tingkat) == 'X' ? 'selected' : '' }}>X
                                                    </option>
                                                    <option value="XI"
                                                        {{ old('tingkat', $ujian->tingkat) == 'XI' ? 'selected' : '' }}>XI
                                                    </option>
                                                    <option value="XII"
                                                        {{ old('tingkat', $ujian->tingkat) == 'XII' ? 'selected' : '' }}>
                                                        XII
                                                    </option>
                                                </select>
                                                @error('tingkat')
                                                ...
                                                <select class="form-select select2 @error('mapel_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($mapels as $mapel)
                                                        <option value="{{ $mapel->id }}"
                                                            ...
                                                            {{ old('mapel_id', $ujian->id_mapel) == $mapel->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <select
                                                    class="form-select select2 @error('id_tahun_ajaran') is-invalid @enderror"
                                                    id="id_tahun_ajaran" name="id_tahun_ajaran" required>
                                                    <option value="">-- Pilih Tahun Pelajaran --</option>
                                                    @foreach ($tahunAjarans as $ta)
                                                        <option value="{{ $ta->id }}"
                                                            {{ old('id_tahun_ajaran', $ujian->id_tahun_ajaran) == $ta->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="col-md-6 mb-2">
                                                                <div class="form-check">
                                                                    <input
                                                                        ...
                                                                        {{ in_array($jurusan->id, old('id_jurusan', is_array($ujian->id_jurusan) ? $ujian->id_jurusan : [])) ? 'checked' : '' }}>
                            ...
                            <div class="card mb-4 border-light">
                                <div class="card-header bg-light py-2">
                                    <h6 class="mb-0 text-primary">
                                        <i class="fas fa-list-alt me-2"></i>Tipe Ujian
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-2">
                                        ...
                                        <select class="form-select select2 @error('type_ujian') is-invalid @enderror"
                                            id="type_ujian" name="jenis_ujian" required>
                                            <option value="">-- Pilih Tipe Ujian --</option>
                                            <option value="Ujian Tengah Semester"
                                                {{ old('jenis_ujian', $ujian->jenis_ujian) == 'Ujian Tengah Semester' ? 'selected' : '' }}>
                                                Ujian Tengah Semester</option>
                                            <option value="Ujian Akhir Semester"
                                                {{ old('jenis_ujian', $ujian->jenis_ujian) == 'Ujian Akhir Semester' ? 'selected' : '' }}>
                                                Ujian Akhir Semester</option>
                                            <option value="Ujian Tengah Tahun"
                                                {{ old('jenis_ujian', $ujian->jenis_ujian) == 'Ujian Tengah Tahun' ? 'selected' : '' }}>
                                                Ujian Tengah Tahun</option>
                                            <option value="Ujian Akhir Tahun"
                                                {{ old('jenis_ujian', $ujian->jenis_ujian) == 'Ujian Akhir Tahun' ? 'selected' : '' }}>
                                                Ujian Akhir Tahun</option>
                                            <option value="Ujian Nasional"
                                                {{ old('jenis_ujian', $ujian->jenis_ujian) == 'Ujian Nasional' ? 'selected' : '' }}>
                            ...
                            <div class="card mb-4 border-light">
                                <div class="card-header bg-light py-2">
                                    <h6 class="mb-0 text-primary">
                                        <i class="fas fa-images me-2"></i>Upload Gambar Soal
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Bisa upload banyak gambar sekaligus</small>
                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <div class="position-relative">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            onclick="deleteGambar({{ $gambar->id }})">
                                ...
                                <div class="card-body">
                                    <div class="mb-2">
                                        ...
                                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan"
                                            rows="3" placeholder="Tambahkan keterangan atau informasi tambahan tentang ujian...">{{ old('keterangan', $ujian->keterangan) }}</textarea>
                                        @error('keterangan')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-warning">
                                                <i class="fas fa-save me-2"></i>Perbarui Ujian
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            $(document).ready(function() {
                ...
                function deleteGambar(id) {
                    if (confirm('Apakah Anda yakin ingin menghapus gambar ini?')) {
                        $.ajax({
                            url: "{{ route($userRole . '.ujian.delete-gambar') }}",
                            type: "POST",
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: id
                ...
                var totalCheckboxes = $('.jurusan-checkbox').length;
                var checkedCheckboxes = $('.jurusan-checkbox:checked').length;
                $('#select_all_jurusan').prop('checked', totalCheckboxes > 0 && totalCheckboxes === checkedCheckboxes);
