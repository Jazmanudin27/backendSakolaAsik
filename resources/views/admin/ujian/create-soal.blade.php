    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route($userRole . '.ujian.store-soal', $ujian->id) }}"
                            ...
                            <div class="col-12">
                                <div class="mb-4">
                                    ...
                                    <div class="border rounded">
                                        <textarea id="soal_editor" name="soal_editor" rows="8"
                                            class="form-control border-0" style="height: 300px;">{{ old('soal_editor') }}</textarea>
                                    </div>
                                    ...
                                    @enderror
                                    <small class="text-muted">Editor mendukung: Gambar, Persamaan Matematika (LaTeX), Format Teks, Tabel, dan lainnya</small>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('bobot') is-invalid @enderror"
                                            id="bobot" name="bobot" value="{{ old('bobot', 1) }}"
                                ...
                                <div class="col-12">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('pembahasan') is-invalid @enderror"
                                            ...
                                            placeholder="Tuliskan pembahasan soal...">{{ old('pembahasan') }}</textarea>
                                        @error('pembahasan')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                            </div>
