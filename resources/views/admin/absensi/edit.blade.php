    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1">Edit Absensi</h1>
                    <p class="text-muted mb-0">Ubah data absensi siswa</p>
                </div>
                <div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route($userRole . '.absensi.update', $absensi->id) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="kode_siswa" required>
                                        ...
                                        @if(isset($siswa))
                                            @foreach($siswa as $sw)
                                                <option value="{{ $sw->kode_siswa }}" {{ old('kode_siswa', $absensi->kode_siswa) == $sw->kode_siswa ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_absensi" class="form-control form-control-sm"
                                       value="{{ old('tanggal_absensi', $absensi->tanggal_absensi->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="keterangan" class="form-control form-control-sm" rows="3" placeholder="Tambahkan keterangan jika diperlukan">{{ old('keterangan', $absensi->keterangan) }}</textarea>
