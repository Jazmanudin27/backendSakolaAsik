            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form action="{{ route($userRole . '.sekolah.update', $sekolah->kode_sekolah) }}" method="POST"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Nama Sekolah <span
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">NPSN <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Kepala Sekolah <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="kepala_sekolah" class="form-control form-control-sm"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Jenjang <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Kabupaten/Kota <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="kabupaten_kota" class="form-control form-control-sm"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Provinsi <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="provinsi" class="form-control form-control-sm"
                                            placeholder="Provinsi" value="{{ old('provinsi', $sekolah->provinsi) }}"
                                            required>
                                        @error('provinsi')
                                            <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" name="status" required>
                                            ...
                                            <option value="Aktif"
                                                {{ old('status', $sekolah->status) == 'Aktif' ? 'selected' : '' }}>Aktif
                                            </option>
                                            <option value="Tidak Aktif"
                                                {{ old('status', $sekolah->status) == 'Tidak Aktif' ? 'selected' : '' }}>
                                                Tidak Aktif</option>
                                        </select>
                                        @error('status')
                                            <div class="text-danger small mt-1">{{ $message }}</div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">No. Telepon <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="no_telp" class="form-control form-control-sm"
                                            placeholder="08123456789" value="{{ old('no_telp', $sekolah->no_telp) }}"
                                            required>
                                        @error('no_telp')
                                            <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control form-control-sm"
                                            placeholder="email@sekolah.com" value="{{ old('email', $sekolah->email) }}"
                                            required>
                                        @error('email')
                                            <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                        ...
                                        <div>
                                            <a href="{{ route($userRole . '.sekolah.index') }}"
