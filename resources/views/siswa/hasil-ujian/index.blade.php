                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <a href="{{ route('siswa.hasil-ujian.show', $hasil->id) }}" class="btn btn-sm btn-primary">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Hasil ujian akan ditampilkan di sini setelah dibuka oleh guru atau admin.</p>
